<nav class="navbar navbar-expand-lg navbar-dark fixed-top navbar-shrink" id="mainNav2">
    <div class="container">
        <a class="navbar-brand" href="/#page-top"><img
                src="{{ asset('/assets/img/logos/Hoteliner-logos_transparent.png') }}" alt="..." /></a>
            ...
            <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                ...
                @if (Auth::check())
                    <li class="nav-item d-flex flex-column align-items-center">
                        <a id="profileBtn" onclick="dropDown()" class="nav-link text-light fw-bold"
                            style="cursor: pointer">
                            Hi! {{ Auth::user()->nama == null ? Auth::user()->username : Auth::user()->nama }} <i
                                class="bi bi-caret-down-fill text-white"></i>
                        </a>
